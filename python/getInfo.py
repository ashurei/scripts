...
for dict_row in reader:
    ...
    d_remote[dict_row['관리장비명']] = list_IP
...
for key,value in d_sims.items():
    sql = "mysql -u tcore -pTcore12# -h tcore-private-vip -e \"select resourceid, resourcename from vw_rep_resource_bas where ip='" + value + "'\" -sN tcore_resource\n"
    f.write(sql)
f.close()
