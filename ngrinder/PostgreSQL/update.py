...
class TestRunner:
	...
	def __call__(self):
		...
		if(nAgent % 2 == 0):
			if(nThread % 2 == 0):
				result = request1.GET("http://60.30.144.108:8080/BMT/jsp_p/update.jsp", params)
			elif(nThread % 2 == 1):
				result = request1.GET("http://60.30.144.108:8081/BMT/jsp_p/update.jsp", params)
		elif(nAgent % 2 == 1):
			if(nThread % 2 == 0):
				result = request1.GET("http://60.30.144.109:8080/BMT/jsp_p/update.jsp", params)
			elif(nThread % 2 == 1):
				result = request1.GET("http://60.30.144.109:8081/BMT/jsp_p/update.jsp", params)
