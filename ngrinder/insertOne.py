...
class TestRunner:
	...
	def __call__(self):
		...
		#if(nAgent % 2 == 0):
		#	result = request1.GET("http://60.30.136.201:8080/BMT2/insert.jsp", params)
		#elif(nAgent % 2 == 1):
		#	result = request1.GET("http://60.30.136.202:8080/BMT2/insert.jsp", params)
		#if(nAgent % 4 == 0):
		#	result = request1.GET("http://60.30.136.201:8080/BMT2/jsp/insert.jsp", params)
		#elif(nAgent % 4 == 1):
		#	result = request1.GET("http://60.30.136.202:8080/BMT2/jsp/insert.jsp", params)
		#elif(nAgent % 4 == 2):
		#	result = request1.GET("http://60.30.136.201:8081/BMT2/jsp/insert.jsp", params)
		#elif(nAgent % 4 == 3):
		#	result = request1.GET("http://60.30.136.202:8081/BMT2/jsp/insert.jsp", params)
		...
		if(nAgent % 8 == 0):
			...
			result = request1.GET("http://60.30.136.201:8082/BMT2/jsp/insert.jsp", params)
		elif(nAgent % 8 == 5):
			result = request1.GET("http://60.30.136.202:8082/BMT2/jsp/insert.jsp", params)
		elif(nAgent % 8 == 6):
			result = request1.GET("http://60.30.136.201:8083/BMT2/jsp/insert.jsp", params)
		elif(nAgent % 8 == 7):
			result = request1.GET("http://60.30.136.202:8083/BMT2/jsp/insert.jsp", params)
